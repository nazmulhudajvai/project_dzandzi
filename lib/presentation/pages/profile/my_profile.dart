                ...
                Row(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          '${profileController.firstName.value.isNotEmpty ? profileController.firstName.value : 'Rahim'} ${profileController.lastName.value.isNotEmpty ? profileController.lastName.value : 'Rehman'}',
                          style: TextStyle(
                        ...
                        Text(
                          profileController.email.value.isNotEmpty ? profileController.email.value : 'rahimrehman@gmail.com',
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            SvgPicture.asset(image, height: 20.h, width: 20.w, fit: BoxFit.contain),
            SizedBox(width: 5.w),
            Text(
              title,
              style: GoogleFonts.roboto(
